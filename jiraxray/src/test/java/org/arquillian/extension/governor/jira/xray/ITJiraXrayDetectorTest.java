...
@RunAsClient
public class ITJiraXrayDetectorTest {
    ...
    // Execute
    @Test
    @JiraXray(value = RESOLVED_ISSUE, detector = @Detector(Detectable.False.class))
    ...
    // Execute
    @Test
    @JiraXray(value = RESOLVED_ISSUE, detector = @Detector(Detectable.True.class))
    ...
    // Execute
    @Test
    @JiraXray(value = UNRESOLVED_ISSUE, detector = @Detector(Detectable.False.class))
    ...
    // Skip
    @Test
    @JiraXray(value = UNRESOLVED_ISSUE, detector = @Detector(Detectable.True.class))
    ...
    // Execute
    @Test
    @JiraXray(value = UNRESOLVED_ISSUE,
            detector = @Detector({Detectable.True.class, Detectable.False.class})
    )
